<?php
	...
	*/
	...
	echo "Creating <strong>uploads</strong> table...";
	flush();
	...
	foreach($tableList as $table) {
		...
		if (substr($table, -6) != "topics" && is_numeric($table)) {
			echo "Adding <strong>upload_id</strong> to table <strong>{$table}</strong>...";
			flush();
	...
	fclose($f);
	echo "<br />Please note any errors that occurred and report them to <a href='http://www.myupb.com\'>MyUPB</a>.'";
