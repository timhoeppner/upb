...
if ($_POST["a"] == "1") {
  ...
  if ($error_msg == "")
	...
	echo "
			<form action='newpost.php?id=".$_GET["id"]."&t=".$_GET["t"]."&quote=". urlencode($_GET["quote"]) ."&t_id=".$_GET["t_id"]."&page=".$_GET["page"]."' method='POST' name='newentry' enctype='multipart/form-data' onSubmit='return validate_$check();'>
