...
?>
<html><head><title>UPB Updater: Step <?php echo $step; ?> of 8 Completed...</title>
...
<p>Thank you for choosing to upgrade your Ultimate PHP Board to Version 2.0!  Version 2.0 offers greater security
than before.  UPB 2, powered by the new Text Database class loads your pages in a fraction of a second.</p>
<p>Before continueing, be sure to note the following so that the upgrade transition is smooth and effortless:</P>
<ul><li>Be sure that you have backed up your db folder</li>
<li>CHMOD the config.php in the root UPB directory to 666</li>
<li>CHMOD the db folder (and all files and folders inside, including files inside folders) in the root UPB directory to 777</li>
<li>CHMOD each skin's folder, located in the skins folder (ex: /upb/skins/default/), to 777</li>
</ul><?php
} elseif($step == 1) {
