...
<div id='upb_container'>
	...
	<div class='main_cat_wrapper'>
		...
		<table class='main_table' cellspacing='1'>
			...
			<tr>
				<td class='area_welcome'><div class='welcome_text'>If you had any problems, please seek support at <a href='http://forum.myupb.com/'>myupb.com's support forums!</a></div></td>
			</tr>
			<tr>
...
<div id='upb_container'>
	...
	<div class='main_cat_wrapper'>
		...
		<table class='main_table' cellspacing='1'>
			...
			<tr>
				<td class='area_welcome' colspan='2'><div class='welcome_text'>If you had any problems, please seek support at <a href='http://forum.myupb.com/'>myupb.com's support forums!</a></div></td>
			</tr>
			<tr>
			...
			<td class='area_1' width='40%'>In kilobytes, type in the maximum size allowed for avatar uploads<br><i>Note: Setting to 0 will only allow linked avatars</i></td>
			<td class='area_2'><input name='avatarupload_size' value='20' size='10'></td>
			</tr>
			<td class='area_1'>In pixels, type in the maximum size allowed for avatar uploads<br>e.g. 100 will allow avatars up to 100x100px.<br>If either the width or height exceeds this limit the avatar will be resized maintaining the correct ratio<br><i>Note: Setting to 0 will only allow linked avatars</i></td>
			<td class='area_2'><input name='avatarupload_dim' value='100' size='10'><br>100px by 100px is the biggest size possible without breaking the default forum layout.</td>
			</tr>
      <tr>
				<td class='area_2' style='text-align:center;font-weight:bold;padding:12px;line-height:20px;' colspan='2'>
          <p style='font-weight:normal;'>
          A new option has been added to custom avatar display which will allow users to choose between uploading an avatar or linking to one. Choose "Both" from the custom avatar option in the Admin Panel to enable this option.</p>
          <p>
					<input type='submit' name='submit' value='Proceed'>&nbsp;<input name='reset' type='reset' value='Reset the form'></form>
			</td>
			</tr>
