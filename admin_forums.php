				...
				<td class='area_2' style='text-align:center;font-weight:bold;padding:12px;line-height:20px;' colspan='7'>No forums exist in this category yet.</td>
					    ...
					    for($j=0,$c2=count($ids);$j<$c2;$j++) {
					       $fRec = $tdb->get('forums', $ids[$j]);
                			...
                			echo "
			<tr>
			    <td class='area_2' style='padding:8px;'>".(($j>0) ? "<a href='admin_forums.php?action=shift&what=forum&where=up&id=".$fRec[0]['id']."'><img src='./images/up.gif'></a>" : "&nbsp;&nbsp;&nbsp;").(($j<($c2-1)) ? "<a href='admin_forums.php?action=shift&what=forum&where=down&id=".$fRec[0]['id']."'><img src='./images/down.gif'></a>" : "")."</td>
