...
if($pass == true) {
			print str_replace("__TITLE__", ALERT_GENERIC_TITLE, str_replace("__MSG__", "The forum has been successfully upgraded to version 2.2.3", ALERT_MSG));
		} else {
	...
	print str_replace("__TITLE__", ALERT_GENERIC_TITLE, str_replace("__MSG__", "The forum must be version 2.2.2 to update to version 2.2.3.  You are currently running ".UPB_VERSION.".", ALERT_MSG));
}
